...
let adx = function (values) {
    let dmWindow = function (serie) {
        ...
        let tr = Math.max(Math.abs(serie[1].h - serie[1].l), Math.abs(serie[1].h - serie[0].c), Math.abs(serie[1].l - serie[0].c));
        return { dmp: dmPos, dmn: dmNeg, tr: tr };
    };
    let result = utils.windowOp(values, 2, dmWindow);
    result.unshift({ dmp: 0, dmn: 0, tr: 0 });
    let firstTr14 = vectors.sumVector(result.slice(0, 15), "tr"), firstDM14Pos = vectors.sumVector(result.slice(0, 15), "dmp"), firstDM14Neg = vectors.sumVector(result.slice(0, 15), "dmn");
...
},{"./utils":9,"./vectors":10}],2:[function(require,module,exports){
"use strict";
var utils = require("./utils");
var vectors = require("./vectors");
/*
...
},{"./utils":9,"./vectors":10}],3:[function(require,module,exports){
"use strict";
var utils = require("./utils");
...
},{"./averages":2,"./statistics":6,"./utils":9}],4:[function(require,module,exports){
// Main entry point for trendyways library
module.exports = {
    // Vectors
    ...require('./vectors'),
    // Averages
...
},{"./adx":1,"./averages":2,"./bollinger":3,"./indicators":5,"./statistics":6,"./stochastic":7,"./sup_res":8,"./utils":9,"./vectors":10}],5:[function(require,module,exports){
"use strict";
var utils = require("./utils");
var vectors = require("./vectors");
...
},{"./averages":2,"./utils":9,"./vectors":10}],6:[function(require,module,exports){
var utils = require("./utils");
var vectors = require("./vectors");
/**
...
},{"./utils":9,"./vectors":10}],7:[function(require,module,exports){
"use strict";
var utils = require("./utils");
var statistics = require("./statistics");
var averages = require("./averages");
...
},{"./averages":2,"./statistics":6,"./utils":9}],8:[function(require,module,exports){
"use strict";
var utils = require("./utils");
/**
